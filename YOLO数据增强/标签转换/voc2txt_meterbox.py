...
if __name__ == "__main__":
    ...
    # VOC格式的XML标签文件路径
    xml_files1 = r'D:\meterbox_defect_datasets\meterbox_yishaixuan_20240814\val_datasets\xmls_shaixuan\1.normal-cabinet'
    # 转换为YOLO格式的TXT标签文件存储路径
    save_txt_files1 = r'D:\meterbox_defect_datasets\meterbox_yishaixuan_20240814\val_datasets\xmls_shaixuan\normal_labels'
