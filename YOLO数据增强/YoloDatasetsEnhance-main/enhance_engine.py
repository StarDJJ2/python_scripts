...
class DataAugmentForObjectDetection():
    def __init__(self, rotation_rate=1, max_rotation_angle=5,
                 crop_rate=0.5, shift_rate=0.5, change_light_rate=0.5,
                 add_noise_rate=0.5, flip_rate=0.5,
                 cutout_rate=0.5, cut_out_length=50, cut_out_holes=1, cut_out_threshold=0.5,
                 is_addNoise=False, is_changeLight=False, is_cutout=False, is_rotate_img_bbox=True,
                 is_crop_img_bboxes=False, is_shift_pic_bboxes=False, is_filp_pic_bboxes=True):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'F:\0-label_dataset\0-finished\images-merge-ori')
    parser.add_argument('--source_xml_path', type=str, default=r'F:\0-label_dataset\0-finished\xmls-merge-v5')
    parser.add_argument('--save_img_path', type=str, default=r'F:\label_dataset_enhanced\0-finished\images-merge-ori')
    parser.add_argument('--save_xml_path', type=str, default=r'F:\label_dataset_enhanced\0-finished\xmls-merge-v5')
